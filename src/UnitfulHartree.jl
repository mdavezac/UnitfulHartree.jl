...
import Unitful
using Unitful: @unit, upreferred, @u_str, ħ, dimension, basefactors


@unit α "α" FineStructureConstant 1/137.03599913931 false
...
@unit c  "c" SpeedOfLight upreferred(e₀^2*kₑ/(1α*ħ)) false
